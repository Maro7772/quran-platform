...
import { createSessionSchema, updateSessionSchema, updateAttendanceSchema } from "./admin.schema.js";
...
export const updateAttendance = async (req, res, next) => {
    try {
        ...
        const upsertPromises = attendance.map((record) => prisma.attendance.upsert({
            where: {
